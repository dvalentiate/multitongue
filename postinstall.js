...
var libMap = {
	...
	squarespace: {sourceFile: 'squarespace.js'}
};
...
var environmentMap = {
	...
	'squarespace': {
		...
		bodyEnd: ''
			...
			+ '\t' + weld('\t', libMap.mt.minified, libMap.element.minified, libMap.language.minified, libMap.squarespace.minified) + '\n'
			+ '\tMultitongue.squarespace(langCodeList);\n'
			+ '</script>'
	},
	'squarespace-with-language-selector': {
		...
		bodyEnd: ''
			...
			+ '\t\n'
			+ '\t' + weld('\t', libMap.mt.minified, libMap.element.minified, libMap.language.minified, libMap.squarespace.minified) + '\n'
			+ '\tvar langIndex = Multitongue.squarespace(langCodeList);\n'
			+ '\t\n'
